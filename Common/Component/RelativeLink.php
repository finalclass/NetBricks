...
class RelativeLink extends Tag
{
     ...
     * @return \NetBricks\Common\Component\RelativeLink
     */
    ...
    {
        $contentSwitcherParents = $this->getParentsByType('\NetBricks\Common\Component\ContentSwitcher\ContentSwitcher');
        $selectedParents = array();
        foreach ($contentSwitcherParents as $contentSwitcher) {
            /**
             * @var \NetBricks\Common\Component\ContentSwitcher\ContentSwitcher $contentSwitcher
             */
